...
clear
echo "========================================================================="
echo "LNMP V0.7 for CentOS/RadHat Linux VPS  Written by Licess"
echo "========================================================================="
...
if [ -s nginx-0.8.54.tar.gz ]; then
  ...
  echo "Error: nginx-0.8.54.tar.gz not found!!!download now......"
...
echo "Install lnmp 0.7 completed! enjoy it."
echo "========================================================================="
echo "LNMP V0.7 for CentOS/RadHat Linux VPS  Written by Licess "
echo "========================================================================="
echo ""
